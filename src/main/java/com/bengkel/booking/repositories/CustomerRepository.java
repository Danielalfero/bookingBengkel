...
public class CustomerRepository {
	...
	public static List<Customer> getAllCustomer(){
		...
		carCust1.setVehicleType("Car");
		motorCust1.setVehicleType("Motorcycle");
		...
		motorCust2.setVehicleType("Motorcycle");
		...
		carCust3.setVehicleType("Car");
		motorCust3.setVehicleType("Motorcycle");
