...
public class ItemServiceRepository {
	...
	public static List<ItemService> getAllItemService(){
		...
		ItemService itemService1 = new ItemService("Svcm-001", "Ganti Oli", "Motorcycle", 70000);
		ItemService itemService2 = new ItemService("Svcm-002", "Service Mesin", "Motorcycle", 150000);
		ItemService itemService3 = new ItemService("Svcm-003", "Service CVT", "Motorcycle", 50000);
		ItemService itemService4 = new ItemService("Svcm-004", "Ganti Ban", "Motorcycle", 200000);
		ItemService itemService5 = new ItemService("Svcm-005", "Ganti Rem", "Motorcycle", 90000);
